 ...
 * Simple HK2 Verticle
 */
public class ParentLocatorVerticle extends AbstractVerticle implements Handler<Message<Void>> {
     ...
     */
    @Inject
    public ParentLocatorVerticle(MyDependency dependency) {
