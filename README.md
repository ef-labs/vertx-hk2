...
`java=com.englishtown~vertx-mod-hk2~1.8.0-SNAPSHOT-SNAPSHOT:com.englishtown.vertx.hk2.HK2VerticleFactory`

or set a system property when running:
`-Dvertx.langs.java=com.englishtown~vertx-mod-hk2~1.8.0-SNAPSHOT-SNAPSHOT:com.englishtown.vertx.hk2.HK2VerticleFactory`
