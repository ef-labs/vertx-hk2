...
`java=com.englishtown~vertx-mod-hk2~1.1.0-SNAPSHOT:com.englishtown.vertx.hk2.HK2VerticleFactory`

or set a system property when running:
`-Dvertx.langs.java=com.englishtown~vertx-mod-hk2~1.1.0-SNAPSHOT:com.englishtown.vertx.hk2.HK2VerticleFactory`
